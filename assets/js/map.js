(async function () {
  ...
  const initial = MapsFilters.filterCompanies(window.__companies, {});
  addMarkers(initial);
  ...
  window.resetMap = function () { clearMarkers(); addMarkers(MapsFilters.filterCompanies(window.__companies, {})); currentFilters = {}; };
})();
