...
(function () {
  ...
  const FALLBACK = {
    ...
    headline: "Resuma sua atuacao em uma frase",
    specialty: "Informe sua especialidade",
    location: "Informe a cidade onde atua",
    experience: "Descreva sua experiencia",
    availability: "Defina sua disponibilidade",
    email: "Adicione um email de contato",
    phone: "Adicione um telefone",
    instagram: "Adicione o usuario do Instagram",
    linkedin: "Adicione o perfil do LinkedIn",
    interviews: "--",
  ...
  document.addEventListener("DOMContentLoaded", () => {
    const form = document.querySelector('[data-edicao-form="usuario"]');
    if (!form) return;

    const preview = document.querySelector('[data-edicao-preview="usuario"]');
