(function () {
  const SELECTORS = {
    form: '[data-edicao-form="usuario"]',
    preview: '[data-edicao-preview="usuario"]',
  ...
  const PREVIEW_SELECTOR = '[data-preview-field]';
  const STORAGE_FALLBACK = 'mapslink:perfil:usuario';
  const EMPTY_IMAGE = 'data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==';
  const FALLBACK = {
    default: '--',
    bio: 'Adicione um resumo profissional',
    skills: 'Inclua competências principais',
    email: 'Informe um e-mail',
    phone: 'Informe um telefone',
    instagram: 'Adicione o @ do Instagram',
    linkedin: 'Informe o LinkedIn',
    availability: 'Informe sua disponibilidade',
    experiences: 'Liste suas últimas experiências',
    headline: 'Resuma sua atuação em uma frase',
    specialty: 'Informe sua especialidade',
    experience: 'Informe sua experiência',
    location: 'Defina sua localização',
  ...
  function clearDraft() {
    ...
    try {
      ...
      console.warn('Não foi possível limpar os dados salvos.', error);
    }
  }
